...
```console
DESCRIPTION:
Solution versioning commands (Alias 'ver')

USAGE:
    dotnet git2semver versioning [OPTIONS] <COMMAND>
...
COMMANDS:
    run               Run version generator
    solution-setup    Solution versioning setup commands (Alias 'setup')
```
